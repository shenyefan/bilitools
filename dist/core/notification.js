...
export async function sendWechatWorkNotification(title, content) {
    const config = getConfig();
    const wechatConfig = config.notification?.wechatWork;
    ...
    try {
        ...
        // 获取访问令牌
        const tokenResponse = await axios.get(`${baseUrl}/cgi-bin/gettoken?corpid=${wechatConfig.corpid}&corpsecret=${wechatConfig.corpsecret}`);
